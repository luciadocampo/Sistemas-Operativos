...
int crear(char *tokens[], int ntokens, list *history){
     if(tokens[1] == NULL){
          char direccion[100];
...
int borrarrec(char *tokens[], int ntokens, list *history){
     char direccion [100];
     if (tokens[1]==NULL){
          printf("%s\n", getcwd(direccion, 100));
          return 0; //para que no siga
...
int listfich(char *tokens[], int ntokens, list *history){
...
int listdir(char *tokens[], int ntokens, list *history){
